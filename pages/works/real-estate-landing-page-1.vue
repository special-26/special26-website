<template>
  <div class="h-full w-full shadow-inner border-t border-zinc-800">
      <!-- Navbar -->
      <navbar class="flex w-full items-center justify-between p-5">
      ...
      <!-- Hero-Area -->
      <div class="hero-area relative px-6">
          <img src="https://images.unsplash.com/photo-1568605114967-8130f3a36994" alt="" class="absolute left-0 top-0 h-[80vh] w-full rounded-xl object-cover" />
          <div class="relative flex h-[80vh] flex-col justify-end gap-6 p-20">
          <h2 class="text-5xl text-white">
              Buy or rent properties <br />
              with no commission
          </h2>
          <div class="flex items-center justify-between gap-5 rounded-xl bg-white/75 p-4">
              <select class="block w-full rounded-md px-4 py-3 pr-9 text-sm">
              ...
              <button class="w-full rounded-md bg-yellow-400 py-3 text-sm text-gray-900">Search</button>
          </div>
          </div>
      </div>
      <!-- Featured Property -->
      <section class="py-10">
          ...
          <div class="mt-6 grid grid-cols-3 gap-6">
              ...
              <figure class="group relative">
                  <img src="https://newhome.qodeinteractive.com/wp-content/uploads/2023/03/main-home-property-460x300.jpg" alt="" class="rounded-lg" />
                  <span class="absolute left-0 top-4 rounded-r-md bg-white/90 px-2 py-2 text-xs">Commercial</span>
                  <span class="absolute bottom-4 right-4 hidden items-center gap-4 group-hover:flex">
                  <button class="h-2.5 w-2.5 rounded-full bg-white"></button>
                  <button class="h-2.5 w-2.5 rounded-full bg-white"></button>
                  <button class="h-2.5 w-2.5 rounded-full bg-white"></button>
                  </span>
              </figure>
              <div class="mt-2 text-sm">VILLAS - Brooklyn</div>
              <h3>Sushma Infinium</h3>
              <p class="text-gray-500">Lorem ipsum dolor sit amet, wisi nemore fastidii at vis, eos equidem admodum</p>
              <div class="card-footer mt-4 flex items-end justify-between border-t pt-4">
                  <h4>24,000</h4>
                  <div class="flex items-center justify-between gap-3">
                  <div class="flex items-center gap-1">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-gray-600" viewBox="0 0 20 20"><path fill="currentColor" d="M13.5 3a2.5 2.5 0 0 1 2.495 2.336L16 5.5v2.55a2.501 2.501 0 0 1 1.994 2.279L18 10.5v6a.5.5 0 0 1-.992.09L17 16.5V14H3v2.5a.5.5 0 0 1-.992.09L2 16.5v-6a2.5 2.5 0 0 1 2-2.45V5.5a2.5 2.5 0 0 1 2.336-2.495L6.5 3h7Zm2 6h-11a1.5 1.5 0 0 0-1.493 1.355L3 10.5V13h14v-2.5a1.5 1.5 0 0 0-1.355-1.493L15.5 9Zm-2-5h-7a1.5 1.5 0 0 0-1.493 1.356L5 5.5V8h1v-.5a.5.5 0 0 1 .5-.5H9a.5.5 0 0 1 .5.5V8h1v-.5A.5.5 0 0 1 11 7h2.5a.5.5 0 0 1 .5.5V8h1V5.5a1.5 1.5 0 0 0-1.355-1.493L13.5 4Z" /></svg>
                      <span class="text-xs">3</span>
                  </div>
                  <div class="flex items-end gap-1">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600" viewBox="0 0 15 15"><path fill="none" stroke="currentColor" d="M0 7.5h15m-10.5 5h6m-6 0a3 3 0 0 1-3-3v-6a3 3 0 0 1 3-3h2V2m-2 10.5V15m6-2.5a3 3 0 0 0 3-3v-2m-3 5V15M5 3.5h3" /></svg>
          ...
          <div class="section-bottom mt-16 flex items-center justify-center">
              <button class="group relative rounded bg-yellow-400 px-6 py-3">
              <span class="absolute left-0 top-0 h-full w-0 bg-yellow-500 transition-all duration-500 group-hover:w-full"></span>
              <span class="relative">Brows More Properties</span>
              </button>
          </div>
          </div>
      </section>
      ...
      <section class="bg-blue-50 py-10">
          <div class="mx-auto flex max-w-6xl items-center gap-12">
          <div class="w-full">
              <figure class="relative">
              <span class="absolute right-6 top-6 h-full w-full bg-yellow-400"></span>
              <img src="https://newhome.qodeinteractive.com/wp-content/uploads/2023/03/main-home-img-1.jpg" class="relative h-full w-full" />
              </figure>
          </div>
          <div class="w-full">
              <h2 class="text-5xl font-semibold mb-5 leading-none">Modern spaces and premium design</h2>
              <p>Lorem ipsum dolor sit amet, minimum inimicus quo no, at vix primis viderere vituperatoribus. In corpora argumentum.</p>
              <button class="group relative mt-6 rounded bg-yellow-400 px-6 py-3">
              <span class="absolute left-0 top-0 h-full w-0 bg-yellow-500 transition-all duration-500 group-hover:w-full"></span>
              <span class="relative">Search Property</span>
              </button>
          </div>
          </div>
      </section>
      ...
      <section class="py-10">
          ...
          <div class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
              ...
              <h2 class="text-5xl font-semibold mb-5 leading-none">How It works?</h2>
              <h2 class="text-5xl font-semibold mb-5 leading-none">Find a perfect home</h2>
              </div>
              <!-- Grid -->
              ...
              <div class="lg:col-span-2">
                  ...
                  <div class="flex flex-col gap-x-5">
                      <svg class="mt-1 h-10 w-10 flex-shrink-0 text-gray-700" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                      ...
                      <div class="grow">
                      <h3 class="mt-2 text-xl font-semibold text-gray-800">Find Real Estate</h3>
                      <p class="mt-1 text-gray-600 dark:text-gray-400">Sumo petentium ut per, at his wisim utinam adipiscing. Est ei graeco quod suavitate vix.</p>
                      </div>
                  </div>
                  <!-- End Icon Block -->
                  <!-- Icon Block -->
      ...
      <section class="">
          ...
          <img src="https://images.unsplash.com/photo-1575517111478-7f6afd0973db" alt="" class="absolute left-0 top-0 h-full w-full object-cover" />
          <div class="relative mx-auto flex w-[70%] items-center justify-between gap-6">
              <div class="w-full">
              <h2 class="text-5xl font-semibold text-white">Discover a new way of living</h2>
              <p class="text-white">Feugait scriptorem qui ea, quo admodum eloquentiam eu. Te malis tibique eum. Ne magna assum everti.</p>
              </div>
              <div class="w-full rounded-xl bg-white/50 p-12 backdrop-blur">
              <h3 class="text-3xl font-semibold">Make an enquiry</h3>
              <p class="my-5">Save your time and easily rent or sell your property with the lowest commission on the real estate market.</p>
              <div class="input-fields mt-5 space-y-5">
                  <input type="text" class="w-full p-3" placeholder="Your Name*" />
                  <input type="text" class="w-full p-3" placeholder="Your Email*" />
                  <input type="text" class="w-full p-3" placeholder="Your phone number*" />
                  <button class="group relative mt-6 rounded bg-yellow-400 px-6 py-3">
                  <span class="absolute left-0 top-0 h-full w-0 bg-yellow-500 transition-all duration-500 group-hover:w-full"></span>
                  <span class="relative">Make enquiry</span>
                  </button>
              </div>
              </div>
          </div>
      ...
      <section class="py-10">
          ...
          <div class="lg:grid lg:grid-cols-12 lg:items-center lg:gap-16">
              ...
              <!-- Grid -->
              <div class="grid grid-cols-12 items-center gap-2 sm:gap-6 lg:-translate-x-10">
              ...
              <div class="space-y-6 sm:space-y-8">
                  ...
                  <h2 class="text-4xl font-bold text-gray-800 lg:text-4xl">Our expert will help you make the renovation</h2>
                  <p class="text-gray-500">Use our tools to explore your ideas and make your vision come true. Then share your work easily.</p>
                  </div>
                  <!-- End Title -->
                  <!-- List -->
                  ...
                  <li class="flex space-x-3">
                      <!-- Solid Check -->
                      <svg class="h-6 w-6 flex-shrink-0 text-blue-600 dark:text-blue-500" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <!-- End Solid Check -->
                      <span class="text-sm text-gray-500 sm:text-base"> <span class="font-bold">Less routine</span> – more creativity </span>
                  </li>
                  <li class="flex space-x-3">
                      <!-- Solid Check -->
                      <svg class="h-6 w-6 flex-shrink-0 text-blue-600 dark:text-blue-500" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <!-- End Solid Check -->
                      <span class="text-sm text-gray-500 sm:text-base"> Hundreds of thousands saved </span>
                  </li>
                  <li class="flex space-x-3">
                      <!-- Solid Check -->
                      <svg class="h-6 w-6 flex-shrink-0 text-blue-600 dark:text-blue-500" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <!-- End Solid Check -->
                      <span class="text-sm text-gray-500 sm:text-base"> Scale budgets <span class="font-bold">efficiently</span> </span>
                  </li>
                  </ul>
                  <!-- End List -->
              </div>
      ...
      <section class="py-10">
          <div class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
          <h2 class="text-5xl font-semibold mb-6">See what others <br/> said about us</h2>
          <!-- Grid -->
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <!-- Card -->
              <div class="flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm">
              <div class="flex-auto p-4 md:p-6">
                  <svg class="h-auto w-20 text-gray-700 sm:w-24" width="140" height="47" viewBox="0 0 140 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p class="mt-3 text-base text-gray-800  sm:mt-6 md:text-xl"><em> " I'm absolutely floored by the level of care and attention to detail the team at HS have put into this theme and for one can guarantee that I will be a return customer. " </em></p>
              </div>
              <div class="rounded-b-xl p-4 md:px-6">
                  <h3 class="text-sm font-semibold text-gray-800 sm:text-base">Nicole Grazioso</h3>
                  <p class="text-sm text-gray-500">Director Payments & Risk | HubSpot</p>
              </div>
              </div>
              <!-- End Card -->
              <!-- Card -->
              <div class="flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm">
              <div class="flex-auto p-4 md:p-6">
                  <svg class="h-auto w-20 text-gray-700 sm:w-24" width="200" height="67" viewBox="0 0 200 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p class="mt-3 text-base text-gray-800  sm:mt-6 md:text-xl"><em> " With Preline, we're able to easily track our performance in full detail. It's become an essential tool for us to grow and engage with our audience. " </em></p>
              </div>
              <div class="rounded-b-xl p-4 md:px-6">
                  <h3 class="text-sm font-semibold text-gray-800 sm:text-base">Josh Tyson</h3>
              ...
              <div class="flex-auto p-4 md:p-6">
                  ...
                  <p class="mt-3 text-base text-gray-800  sm:mt-6 md:text-xl"><em> " In September, I will be using this theme for 2 years. I went through multiple updates and changes and I'm very glad to see the consistency and effort made by the team. " </em></p>
              </div>
              <div class="rounded-b-xl p-4 md:px-6">
                  <h3 class="text-sm font-semibold text-gray-800 sm:text-base">Luisa</h3>
                  <p class="text-sm text-gray-500">Senior Director of Operations | Fitbit</p>
              </div>
              </div>
              <!-- End Card -->
          </div>
      ...
      <section class="py-10">
          <div class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
          <h2 class="text-5xl font-semibold mb-6">Read our real <br/> estate recent news</h2>
          <!-- Card Blog -->
          <div class="">
              <!-- Grid -->
      ...
      <!-- footer -->
      <footer class="w-full py-5 px-12 mx-auto">
          <!-- Grid -->
          <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
          <div class="col-span-full hidden lg:col-span-1 lg:block">
              <a class="flex-none text-xl font-semibold" href="#" aria-label="Brand">Brand</a>
              <p class="mt-3 text-xs sm:text-sm text-gray-600">© 2022 Footer.</p>
          </div>
          <!-- End Col -->
          <div>
